...
export default function Hero({ mode, toggle }) {
  ...
  return (
    <>
      <section className="hero" data-section id="home">
        <div
          className={locale == "ar" ? "container direction-rtl" : "container"}
        >
          <div className="header-content">
            ...
            <p>
              {t(
                "The leading platform to Create your website for free with the help of AI in the Middle East"
              )}
            </p>
            <div
            ...
            >
              <Button
                mode={mode}
                heroBtn="hero-btn"
                body={t("Try it for free")}
              />
              <Image
                className={locale == "en" ? "pointer" : "pointer-ar"}
                src={locale == "en" ? "/pointer.svg" : "/pointer-ar.svg"}
                alt=""
                width={102}
                height={45}
                priority
          ...
          <DarkLightMode mode={mode} toggle={toggle} locale={locale} />
        </div>
      </section>
    </>
  );
